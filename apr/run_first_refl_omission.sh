#!/bin/bash
#SBATCH --job-name=first_refl_omit_pass_at1_iter11_Qwen_40
...
#SBATCH --output=logs/first_refl_omit_pass_at1_iter11_Qwen_40_output.txt
#SBATCH --error=logs/first_refl_omit_pass_at1_iter11_Qwen_40_error.txt
...
python main.py \
--run_name "first_refl_omit_pass_at1_iter11_Qwen_40" \
--root_dir "root" \
...
--pass_at_k "1" \
--max_iters "11" \
--verbose | tee ./logs/first_refl_omit_Qwen_40
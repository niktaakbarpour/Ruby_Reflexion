#!/bin/bash
#SBATCH --job-name=test_gen_omit_pass_at1_iter11_Qwen_40
...
#SBATCH --output=logs/test_gen_omit_pass_at1_iter11_Qwen_40_output.txt
#SBATCH --error=logs/test_gen_omit_pass_at1_iter11_Qwen_40_error.txt
...
python main.py \
--run_name "test_gen_omit_pass_at1_iter11_Qwen_40" \
--root_dir "root" \
...
--pass_at_k "1" \
--max_iters "11" \
--verbose | tee ./logs/test_gen_omit_Qwen_40
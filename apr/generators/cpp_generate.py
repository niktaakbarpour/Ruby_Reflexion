...
from .generator_utils_cpp import (
...
from .prompt_constants_cpp import (
...
from .cpp_parse import parse_code_block, add_code_block
...
class CppGenerator(Generator):
    def self_reflection(self,
        ...
        return generic_generate_self_reflection(
            ...
            add_code_block=lambda x: add_code_block(x, "cpp"),
    ...
    def func_impl(
        ...
        return generic_generate_func_impl(
            ...
            parse_code_block=lambda x: parse_code_block(x, "cpp"),
            add_code_block=lambda x: add_code_block(x, "cpp"),
        )
